...
export default function CodeWorkbook({ onClose, selectedShipment }: CodeWorkbookProps) {
  ...
  return (
    <div className="w-[600px] border-l border-border bg-void flex flex-col shadow-2xl z-20">
      {/* Notebook Header */}
      <div className="h-12 border-b border-border bg-void-light flex items-center justify-between px-4">
        <div className="flex items-center gap-3">
          ...
          <span className="font-bold text-sm tracking-wide text-text-bright">
            Analysis: {selectedShipment ? `${selectedShipment.trackingCode}_Anomaly` : 'Global_Logistics'}.ipynb
          </span>
          <span className="text-[10px] bg-border px-1.5 py-0.5 rounded text-text-muted">PYTHON 3.9</span>
        </div>
